...
description: Generate Suno AI prompts in Thai, English, or bilingual Thai+English. Use when user mentions Suno, AI music, แต่งเพลงด้วย AI, สร้างเพลงไทย, write a song for Suno, T-pop/Thai pop/Thai rock, or English pop/rock/country/hip-hop/R&B/folk/EDM. Triggers: "ช่วยแต่งเพลง suno", "อยากทำเพลงไทย AI", "เขียน prompt สำหรับ suno", "Thai lyrics for Suno", "write English song for Suno", "bilingual T-pop", or any songwriting request for AI music. Produces Lyrics + Styles + Title + sliders (Vocal Gender, Weirdness, Style Influence) for v4.5/v5/v5.5. Applies Thai conventions (tonal-melodic alignment, ฉันทลักษณ์) and English conventions (Pattison prosody, rhyme types, hook placement). Warns about เพี้ยน for Thai, homographs for English. Runs rhyme audits (สัมผัสนอก/ใน, perfect/family/assonance) and language anchoring for bilingual songs.
---
